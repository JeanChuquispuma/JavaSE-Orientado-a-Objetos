...
public class UIDoctorMenu {
    ...
    private static void showAddAvaibleAppointmentsMenu(){
        ...
        do {
            System.out.println();
            System.out.println("::Add Avaible Appointemnt");
            ...
            if (response > 0 && response < 4){
                ...
                checkDoctorAvaibleAppointments(UIMenu.doctorLogged);
    ...
    private static void checkDoctorAvaibleAppointments(Doctor doctor){
