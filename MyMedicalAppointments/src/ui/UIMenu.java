...
public class UIMenu {
    ...
    private static void authUser(int userType){
        //userType = 1 Doctor sino 2 Paciente
        ArrayList<Doctor> doctors = new ArrayList<>();
        doctors.add(new Doctor("Alejandro Martinez", "alejandro@gmail.com"));
        doctors.add(new Doctor("Karen Sosa", "karen@gmail.com"));
        doctors.add(new Doctor("Rocío Gómez", "rocío@gmail.com"));

        ArrayList<Patient> patients = new ArrayList<>();
        patients.add(new Patient("Jean Chuquispuma","chuquis@gmail.com"));
        patients.add(new Patient("Roberto Rodriguez","rodrigues@gmail.com"));
